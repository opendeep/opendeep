...
setup(
    name='opendeep',
    version=version,
    description='A modular and extensible deep learning library built on TensorFlow.',
    long_description=read(readmefile),
    keywords='opendeep tensorflow modular deep learning neural net ai machine representation',

    url='https://github.com/opendeep/opendeep/',
